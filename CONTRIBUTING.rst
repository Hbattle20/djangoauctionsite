...
Welcome to ``auctionsite`` contributor's guide.
...
If you experience bugs or general issues with ``auctionsite``, please have a look
...
You can help improve ``auctionsite`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``auctionsite`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``auctionsite``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n auctionsite python=3 six virtualenv pytest pytest-cov
    conda activate auctionsite
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/auctionsite.git
    cd auctionsite
...
#. Install |pre-commit|_::
   ...
   ``auctionsite`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/auctionsite
.. _issue tracker: https://github.com/<USERNAME>/auctionsite/issues
.. <-- end -->
